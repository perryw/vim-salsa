...
" Maintainer:	Perry Wong <pwong@salsalabs.com>
" Adapted from jsp ftplugin file
...
let s:undo_ftplugin = ""
let s:browsefilter = "JS Files (*.js)\t*.js\n" .
	    \	 "HTML Files (*.html, *.htm)\t*.html;*.htm\n" .
	    \	 "All Files (*.*)\t*.*\n"
let s:match_words = ""

runtime! ftplugin/html.vim ftplugin/html_*.vim ftplugin/html/*.vim ftplugin/javascript.vim
...
if exists("g:invert_sjs_number_row")
